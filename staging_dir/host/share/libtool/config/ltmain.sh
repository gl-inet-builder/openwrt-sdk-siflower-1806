...
if test -n "$STAGING_DIR"; then
	...
	: ${EGREP="/work/work/gl-infra-builder/openwrt-18.06/siflower/openwrt-18.06/staging_dir/host/bin/grep -E"}
	: ${FGREP="/work/work/gl-infra-builder/openwrt-18.06/siflower/openwrt-18.06/staging_dir/host/bin/grep -F"}
	: ${GREP="/work/work/gl-infra-builder/openwrt-18.06/siflower/openwrt-18.06/staging_dir/host/bin/grep"}
	: ${SED="/work/work/gl-infra-builder/openwrt-18.06/siflower/openwrt-18.06/staging_dir/host/bin/sed"}
fi
